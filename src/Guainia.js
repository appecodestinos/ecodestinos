        ...
        <div className="pagina-territorio fade-in">
            ...
            <div className="hero-territorio">
                ...
                <div className="overlay-titulo">
                    <h1 className="cinzel-font">GUAINIA</h1>
                    <p className="arquetipo-sub">{t("destinos.Guainia.archetype") || info.arquetipo}</p>
                </div>
            </div>
            ...
            <div className="contenido-multimedia-wrap">
                <div className="bloque-texto">
                    ...
                    <p className="texto-maestro">{t("destinos.Guainia.sabiduria_larga") || t("destinos.Guainia.desc") || info.sabiduria_larga || info.desc}</p>
                </div>
