        ...
        <div className="pagina-territorio fade-in">
            ...
            <div className="hero-territorio">
                ...
                <div className="overlay-titulo">
                    <h1 className="cinzel-font">AMAZONAS</h1>
                    <p className="arquetipo-sub">{t("destinos.Amazonas.archetype") || info.arquetipo}</p>
                </div>
            </div>
            ...
            <div className="contenido-multimedia-wrap">
                <div className="bloque-texto">
                    ...
                    <p className="texto-maestro">{t("destinos.Amazonas.sabiduria_larga") || t("destinos.Amazonas.desc") || info.sabiduria_larga || info.desc}</p>
                </div>
