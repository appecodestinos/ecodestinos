                ...
                {DESTINOS.map((d) => (
                    ...
                    >
                        <img
                            src={d.iconoImg}
                            alt={d.id}
                            style={d.id === 'Antioquia' ? { width: '130%', height: '130%', objectFit: 'cover', borderRadius: '50%', position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)' } : { width: '100%', height: '100%', objectFit: 'contain' }}
                        />
                    </button>
                ))}
