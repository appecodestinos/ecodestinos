        ...
        <div className="pagina-territorio fade-in">
            ...
            <div className="hero-territorio">
                ...
                <div className="overlay-titulo">
                    <h1 className="cinzel-font">PUTUMAYO</h1>
                    <p className="arquetipo-sub">{t("destinos.Putumayo.archetype") || info.arquetipo}</p>
                </div>
            </div>
            ...
            <div className="contenido-multimedia-wrap">
                <div className="bloque-texto">
                    ...
                    <p className="texto-maestro">{t("destinos.Putumayo.sabiduria_larga") || t("destinos.Putumayo.desc") || info.sabiduria_larga || info.desc}</p>
                </div>
