        ...
        <div className="pagina-territorio fade-in">
            ...
            <div className="hero-territorio">
                ...
                <div className="overlay-titulo">
                    <h1 className="cinzel-font">MEDELLÍN</h1>
                    <p className="arquetipo-sub">{t("destinos.Medellin.archetype") || info.arquetipo}</p>
                </div>
            </div>
            ...
            <div className="contenido-multimedia-wrap">
                <div className="bloque-texto">
                    ...
                    <p className="texto-maestro">{t("destinos.Medellin.desc") || info.desc}</p>
                </div>
