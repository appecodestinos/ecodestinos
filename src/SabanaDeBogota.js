...
const SabanaDeBogota = ({ info, onVolver }) => {
        ...
        <div className="pagina-territorio fade-in">
            ...
            <div className="hero-territorio">
                ...
                <div className="overlay-titulo">
                    <h1 className="cinzel-font">SABANA DE BOGOTÁ</h1>
                    <p className="arquetipo-sub">{t("destinos.Sabana.archetype") || info.arquetipo}</p>
                </div>
            </div>
            ...
            <div className="contenido-multimedia-wrap">
                <div className="bloque-texto">
                    ...
                    <p className="texto-maestro">{t("destinos.SabanaDeBogota.sabiduria_larga") || t("destinos.Sabana.sabiduria_larga") || t("destinos.Sabana.desc") || info.sabiduria_larga || info.desc}</p>
                </div>
